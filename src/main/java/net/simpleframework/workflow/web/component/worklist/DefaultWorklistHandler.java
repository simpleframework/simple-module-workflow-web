...
public class DefaultWorklistHandler extends AbstractDbTablePagerHandler implements
	...
	// final ID userId = ((IPagePermissionHandler)
	// context.getParticipantService()).getLoginId(cp);
	...
	// final IDataQuery<ActivityBean> qs =
	// context.getActivityService().getNextActivities(
	// activity);
	...
	// if (userFrom == null) {
	// final StringBuilder sb = new StringBuilder();
	// final IDataQuery<WorkitemBean> qs =
	// context.getWorkitemService().getWorkitemList(activity,
